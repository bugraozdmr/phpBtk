...
<?php include "partials/_navbar.php" ?>
    ...
    <?php
        ...
        $username = $password = $reppassword = $email = $city  = '';
        $hobies = [];
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if(empty($_POST['reppassword'])){ 
                ...
                $reppassword = safe_html($_POST['reppassword']);
            }
            ...
            <div class="col-12">
                <form action="register.php" method="post">
                    ...
                    <div class="mb-3" style="display: flex;flex-direction:column">
                        ...
                        <?php foreach($hobbies as $key => $hobi) :?>
                        <div class="form-check">
                            <input type="checkbox" name="hobies[]" value=<?php echo $key ?> id="hobie_<?php echo $key ?>">
                            <label for="hobie_<?php echo $key ?>" class='form-check-label'><?php echo $hobi ?></label>
                        </div>
                        <?php endforeach; ?>
